...
class MLXLoRATrainer:
    ...
    def train(
        ...
        try:
            ...
            tracker = ProgressTracker(progress_callback, dataset_len, training_config.epochs)
    ...
    def _save_model(
        ...
        try:
            ...
            if adapter_dir.exists():
                for adapter_file in adapter_dir.glob("*.safetensors"):
                ...
                if (adapter_dir / "adapter_config.json").exists():
                    shutil.copy2(adapter_dir / "adapter_config.json", output_dir / "adapter_config.json")
            ...
            with open(output_dir / "fine_tuned.marker", 'w') as f:
                ...
                f.write(f"Adapter path: {adapter_dir}\n")
